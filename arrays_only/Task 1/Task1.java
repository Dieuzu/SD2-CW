...
public class Task1{
    public static String[] CovidBooth = new String[6]; //Array that holds Names of patients in all 6 booths
    public static int boothNum = 0;
    public static int CVStock = 150;  // Variable to hold Vaccination Stock

    public static void main(String[] args) {

        for (int x = 0; x < 6; x++)  //initializing the primitive array with all empty values
            CovidBooth[x] = "e";
